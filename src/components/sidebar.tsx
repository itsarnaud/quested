          ...
          {items.map(({ href, label, icon: Icon, showDot }) => {
            ...
            return (
              <Link
                ...
                href={href}
                className={cn(
                  "relative flex items-center gap-3 rounded-md px-2 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground",
